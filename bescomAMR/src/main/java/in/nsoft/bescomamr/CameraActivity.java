...
public class CameraActivity extends Activity implements SensorEventListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPreview = new CameraPreview(CameraActivity.this, SVCamera);
		...
		//END Sensor Manager=======================mDisplay = mWindowManager.getDefaultDisplay();=============================
		...
		btnSave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(!isCaptured)
				{
					CustomToast.makeText(CameraActivity.this, "Please Capture Photo to Proceed.", Toast.LENGTH_SHORT);
					return;
				}
				else
				{
					...
					{
						Intent i = new Intent(CameraActivity.this, SurveyWaterActivity.class);
						startActivity(i);
						finish();
					}
					else //Electricity Survey
					{
						Intent i = new Intent(CameraActivity.this, SurveyDetailsActivity.class);
						startActivity(i);
						finish();
					}
				}
	...
	public void onBackPressed() {
		Intent i = new Intent(CameraActivity.this, Billing.class);
		startActivity(i);
	}
	@Override
	...
	PictureCallback jpegCallback = new PictureCallback() {
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			...
			try 
			{
				...
				fileo = new File("/data/data/in.nsoft.bescomamr/databases/photo/", filen);
			...
			CustomToast.makeText(CameraActivity.this, "If READING is Not Visible Please Retake Photo", Toast.LENGTH_LONG);
		}
	};
